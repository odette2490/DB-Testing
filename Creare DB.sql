...
-- Creare Tabela Pets: (PetI este primary key pentru aceasta tabela. Aceasta este foreign Key in Tabela Appointments.)
CREATE TABLE Pets (
...
-- Creare tabela Owners (OwnerID este primary key pentru aceasta tabela. Aceasta este foreign Key in Tabela Appointments.)
CREATE TABLE Owners (
...
-- Creare tabela Appointments (aceasta tabela sa creaza ultima, intrucat are 2 foreign keys, prin care se face relationarea la tabelele Owners si Pets;totodata OwnerID este o variabila comuna in toate cele 3 tabele)
